                ...
                <div className='ContenedorMedioS3'>
                    ...
                    <section className='Seccion3TC'>
                        ...
                        <div className='itemsP3'>
                            <p>
                                Al momento del registro en la plataforma, se recoje información de: Clientes y asesores jurídicos.
                            </p>

                            <p> Despues del registro,también se recoje información de: Clientes y asesores juridicos.
                            </p>

                            <p>
                                Finalmente, también se recopila información personal que usted nos
                                proporciona voluntariamente cuando se pone en contacto con nosotros a
                                través de:
                                <ul>
                                    <li>
                                        Correo electrónico
                                    ...
                                    <li>
                                        A través de la herramienta Whatsapp de nuestra plataforma
                                    </li>
