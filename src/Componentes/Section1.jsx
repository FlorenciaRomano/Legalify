...
function Section1() {
  ...
  const elementos = [Escena1, Escena2, Escena3, Escena4, Escena5, Escena6, Escena7]
  ...
  return (
    ...
    className='sectionPrin'>
      <Box sx={{width:{md:'400px'}}} className='section1'>
        ...
        <p>¿Necesitas financiar los honorarios? ¡Tenemos la solución para ti! Haz clic en el botón a continuación para obtener más información.</p>

        <div className='botonesS1'>
          <a className='registrarse' href='https://login.legalify.app/redes?rol=2' src={Button}>
            Registrarse
          </a>
          <a className='financiar' href='https://login.legalify.app/redes?rol=2' src={Button}>
            Financiar
          </a>
        </div>
      </Box>
