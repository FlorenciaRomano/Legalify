        ...
        <div className='ContenedorMedioS12'>
          <section className='Seccion3TC'>
            ...
            <div className='itemsP3'>
              <span>
                <h5>Derecho a controlar sus datos personales:</h5>
                <ul>
              ...
              <span>
                <h5>Derecho a la portabilidad de sus datos personales:</h5>
                <p>Tiene derecho a solicitar la devolución de sus datos personales a Legalify o pedirnos que los transfiramos a otra empresa.</p>
              </span>

              <span>
                <h5>Derecho a limitar el tratamiento de sus datos personales:</h5>
                <ul>
                  <li>Si cree que su información personal es inexacta y ha solicitado su verificación.</li>
                  <li>Si el tratamiento de su información es ilegal y usted se ha opuesto a su eliminación, solicitando en su lugar que limitemos su uso.</li>
                  <li>Si Legalify ya no necesita su información para fines de procesamiento, pero usted la necesita para ejercer o defender reclamaciones legales.</li>
                  <li>Si usted se ha opuesto al tratamiento de su información personal basándose en el artículo 21, apartado 1, del GDPR. Verificaremos si nuestras razones para procesar sus datos prevalecen sobre sus objeciones.</li>
                </ul>
              </span>
            </div>
          </section>
